...
import { GraduationCap, SuitcaseSimple, Link, User, Code, Heart } from '@phosphor-icons/react'
    ...
    <ModalShell onClose={onClose} size="lg">
      <div className={styles.container}>
        ...
        <div className={styles.topSection}>
          <div className={styles.profileCard}>
            ...
            <div className={styles.cardLeft}>
              <img src={avatarPlaceholder} alt="Avatar" className={styles.avatar} />
              ...
              <div className={styles.infoList}>
                ...
                {member.cvLink && (
                  <div className={styles.infoItem}>
                    ...
                    <span className={styles.infoText}>
                      Portfolio: <a href={member.cvLink} target="_blank" rel="noreferrer" className={styles.cvLink}>Xem chi tiết</a>
                    </span>
                  </div>
                )}
              </div>
        ...
        <div className={styles.bottomSection}>
          ...
          {(allTags.length > 0 || topics.length > 0) && (
